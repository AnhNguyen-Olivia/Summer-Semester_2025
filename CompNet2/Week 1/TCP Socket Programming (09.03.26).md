...
>- [[TCP Socket Programming (09.03.26)#Review|Review]]
>- [[TCP Socket Programming (09.03.26)#Client/Server Model|Client/Server Model]]
>- [[TCP Socket Programming (09.03.26)#Socket|Socket]]
>- [[TCP Socket Programming (09.03.26)#TCP|TCP ]]
>- [[TCP Socket Programming (09.03.26)#Socket class|Socket class]]
>   - [[TCP Socket Programming (09.03.26)#TCP|TCP]]
>      - [[TCP Socket Programming (09.03.26)#Socket|Socket]]
>      - [[TCP Socket Programming (09.03.26)#ServerSocket (Server-Side)|ServerSocket (Server-Side)]]
>- [[TCP Socket Programming (09.03.26)#TCP communication|TCP communication]]
>   - [[TCP Socket Programming (09.03.26)#Client Steps|Client Steps]]
>   - [[TCP Socket Programming (09.03.26)#Server Steps|Server Steps]]
>- [[TCP Socket Programming (09.03.26)#Examples|Examples]]
>   - [[TCP Socket Programming (09.03.26)#Example 1: String to uppercase (Text Stream)|Example 1: String to uppercase (Text Stream)]]
>      - [[TCP Socket Programming (09.03.26)#TCPClient.java|TCPClient.java]]
>      - [[TCP Socket Programming (09.03.26)#TCPServer.java|TCPServer.java]]
>   - [[TCP Socket Programming (09.03.26)#Rules|Rules]]
>   - [[TCP Socket Programming (09.03.26)#Example 2: Integer Subtraction (Binary Streams)|Example 2: Integer Subtraction (Binary Streams)]]
>      - [[TCP Socket Programming (09.03.26)#TCPClient.java|TCPClient.java]]
>      - [[TCP Socket Programming (09.03.26)#TCPServer.java|TCPServer.java]]
>   - [[TCP Socket Programming (09.03.26)#Input and Output Streams|Input and Output Streams]]
>   - [[TCP Socket Programming (09.03.26)#SSL Socket|SSL Socket]]
>   - [[TCP Socket Programming (09.03.26)#Example 3 "Bad" problems|Example 3 "Bad" problems]]
>      - [[TCP Socket Programming (09.03.26)#Bad TCPClient.java|Bad TCPClient.java]]
>      - [[TCP Socket Programming (09.03.26)#Bad TCPServer.java|Bad TCPServer.java]]
>      - [[TCP Socket Programming (09.03.26)#Problem|Problem]]
>   - [[TCP Socket Programming (09.03.26)#Synchronization between Client and Server|Synchronization between Client and Server]]
>   - [[TCP Socket Programming (09.03.26)#Good Client with Delimiter|Good Client with Delimiter]]
>      - [[TCP Socket Programming (09.03.26)#TCPClient.java|TCPClient.java]]
>      - [[TCP Socket Programming (09.03.26)#TCPServer.java|TCPServer.java]]
>   - [[TCP Socket Programming (09.03.26)#Good Client with Length-prefix (Recommended)|Good Client with Length-prefix (Recommended)]]
>      - [[TCP Socket Programming (09.03.26)#TCPClient.java|TCPClient.java]]
>      - [[TCP Socket Programming (09.03.26)#TCPServer.java|TCPServer.java]]
>   - [[TCP Socket Programming (09.03.26)#Supporting many clients simultaneously|Supporting many clients simultaneously]]
>- [[TCP Socket Programming (09.03.26)#Summary|Summary]]
# Review
...
# Summary
If we use TCP for transmission, the data is delivered in order and no lost happens. Java hides all complex steps of setting up connection and data transmission between Client and Server. Client /Server program has 4 [[TCP Socket Programming (09.03.26)#TCP communication|steps]] (create socket, create streams, implement function, close socket). We need to guarantee the synchronization of Client and Server.